  ...
  ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <button type="button" class="btn btn-sm btn-outline-secondary">
          <?php
          $sql="Select * from student where matricnumber='$_SESSION[stud]'";
    ...
    <?php
          if(isset($_POST['submit'])){
            ...
            $sql="INSERT INTO feedbacks(title, content, matricnumber) VALUES('$title', '$feedback', '$stud')";
            if($result=mysqli_query($conn, $sql)){
              ...
              if(move_uploaded_file($files_tmp, $upload_dir)){
                $sqls="INSERT INTO file_tbl VALUES(null, '$upload_dir', '$feedback_id' )";
        ...
        <div class="container">
          <div class="row">
            ...
            <?php
              $sql="Select * from feedbacks INNER JOIN file_tbl WHERE feedbacks.matricnumber = '$stud'  AND feedbacks.id=file_tbl.feedbacks_id order by feedbacks.created_at  desc";
              $result=mysqli_query($conn, $sql);
              if($result === false){
