...
$sql="Select * from cl_group order by id asc";
...
<body class="text-center">
        <div class="row bg-secondary text-white">
            <div class="col-2 ">cl_Group Id</div>
        ...
        <div class="row bg-light py-4">
            ...
            $count_sql ="Select count(distinct matricnumber) from cl_group INNER JOIN students WHERE students.cl_group_id = '$stud_count'";
...
if(isset($_GET['del_id'])){
    ...
    $sql= "DELETE FROM cl_group WHERE id ='$id'";
