...
$sql="Select * from student INNER JOIN cl_group where student.group_id = cl_group.id AND cl_group.admin_id='$admin_id' order by id asc";
...
if(isset($_GET['del_id'])){
    ...
    $sql= "DELETE FROM student WHERE matricnumber ='$id'";
